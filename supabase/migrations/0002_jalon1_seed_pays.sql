-- Jalon 1 — liste des pays disponibles à la création du compte.
-- Liste complète ISO 3166-1 alpha-2 (choix d'Adrien : pas de liste
-- restreinte pour le MVP). Noms localisés fr/en générés via le paquet
-- i18n-iso-countries (docs/DECISIONS.md §4, Jalon 1).

-- 250 pays (ISO 3166-1 alpha-2)
insert into public.countries (id, nom_fr, nom_en) values
  ('AD', 'Andorre', 'Andorra'),
